...
- [x] 1. Initial spec commit
  - [x] 1.1 Create feature branch `feat/override-ux-redesign` from current branch
  - [x] 1.2 Commit spec files with message `docs: Add override-ux-redesign spec`
...
- [x] 2. Update DOM selectors and CSS classes
  - [x] 2.1 Add new DOM selectors to `constants/dom-selectors.ts`
  ...
  - [x] 2.2 Update `css/style.css` with new override visibility styles and checkbox column layout
...
- [x] 3. Restructure template for new override layout
  - [x] 3.1 Restructure party member character cards in `templates/party-chronicle-filling.hbs`
  ...
  - [x] 3.2 Restructure GM character card in `templates/party-chronicle-filling.hbs`
...
- [x] 4. Update override handlers for visibility toggle behavior
  - [x] 4.1 Update `handleOverrideXpChange()` in `handlers/override-handlers.ts`
  ...
  - [x] 4.2 Update `handleOverrideCurrencyChange()` in `handlers/override-handlers.ts`
    - Replace strikethrough logic with visibility toggle:
  ...
  - [x] 4.3 Update `initializeOverrideStates()` in `handlers/override-handlers.ts`
...
- [x] 5. Update collapsible section handler
  - [x] 5.1 Remove `advanced-{characterId}` support from `handlers/collapsible-section-handlers.ts`
...
- [x] 6. Write tests for the redesigned override behavior
  - [x] 6.1 Write unit tests for updated `handleOverrideXpChange()`
  ...
  - [x] 6.2 Write unit tests for updated `handleOverrideCurrencyChange()`
  ...
  - [x] 6.3 Write unit tests for updated `initializeOverrideStates()`
  ...
  - [x] 6.4 Write unit tests for template structure changes
  ...
  - [x] 6.5 Write property test: XP override visibility toggle consistency
    - **Property 1: XP override visibility toggle is consistent with checkbox state**
    - **Validates: Requirements 2.1, 2.2, 2.3, 2.4, 2.7**

  - [x] 6.6 Write property test: Currency override visibility toggle consistency (Pathfinder)
  ...
  - [x] 6.7 Write property test: Currency override visibility toggle consistency (Starfinder)
  ...
  - [x] 6.8 Write property test: Currency override default value equals sum of calculated values
    - **Property 4: Currency override default value equals sum of calculated values**
    - **Validates: Requirements 3.6, 8.1, 8.3, 8.4**

  - [x] 6.9 Write property test: Override state restoration on form load
    - **Property 5: Override state restoration on form load**
    - **Validates: Requirements 7.4**

  - [x] 6.10 Write property test: Per-character override independence
...
- [x] 8. Verify existing override logic is preserved
  - [x] 8.1 Run existing override-related tests to confirm no regressions
